...
def inject_stealth_scripts(context):
    ...
    """Injects JavaScript overrides on every page to mask Playwright automation fingerprints.

    This runs BEFORE any page script executes, preventing bot detection."""

    context.add_init_script("""

        // #1 Fix: Override navigator.webdriver - the most common CAPTCHA trigger
        ...
        // #2 Fix: Restore chrome.runtime to look like a genuine browser session
        ...
        // #3 Fix: Restore Notification permissions API (automation changes this)
        ...
        // #4 Fix: Fake plugins array to match a real browser
        ...
        // #5 Fix: Ensure languages look natural
        ...
        // #6 Fix: Hide that DevTools protocol is attached
    ...
    print("[Stealth] Anti-detection scripts injected into browser context.")
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            context = p.chromium.launch_persistent_context(
                ...
                # Real Chrome User-Agent — prevents UA-based bot detection
                ...
                args=[
                    ...
                    "--disable-blink-features=AutomationControlled",  # Hides automation mode from fingerprinting JS

                    "--disable-features=IsolateOrigins,site-per-process",

                    "--password-store=basic",   # Prevents keychain/credential popups
                ...
                ignore_default_args=[
                    ...
                    "--enable-automation",            # Removes the 'controlled by automation' banner & JS signal
            ...
            # Inject stealth scripts immediately after context launch
